...
export HOST PORT SSL_CERT_FILE SSL_KEY_FILE MYSQLSH_BINARY FLASK_SECRET_KEY FLASK_SECRET_KEY_FILE
export MYSQL_SHELL_WEB_SESSION_COOKIE_SECURE MYSQL_SHELL_WEB_VERSION_URL MYSQL_SHELL_WEB_VERSION_CA_BUNDLE
export MYSQL_SHELL_WEB_UPDATE_ALLOWED_REMOTE_URL MYSQL_SHELL_WEB_UPDATE_ALLOWED_BRANCH
